package cn.edu.gdmec.c07150807.thread;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void anr(View v) {
        for (int i = 0; i < 100000; i++) {
            //循环读一张图，超时时出现ANR(Application Not Responsing)
    ...
    public void handlermessage(View v) {
        ...
        class MyTask extends TimerTask {
            ...
            @Override
            public void run() {
                //obtain()方法直接从信息池中去取出一个可用的消息对象，比new Message()方法效率高
                Message msg = Message.obtain();
                //定义消息标志为1
                msg.what = 1;
                //每次运行都把countdown减一，arg1和arg2是消息传递信息的高效率方法，但只能int类型。
                msg.arg1 = countdown--;
...
//显示消息的方法
    ...
    //这个方法工作在UI线程可以更新UI
            ...
            protected void onProgressUpdate(String... values) {
                ...
                //showmsg(valuse[0]);//这个调用也有效
                super.onProgressUpdate(values);
            }
            //执行耗时操作后处理UI线程事件，接收doInBackground的返回值，这个方法gonzalez在UI线程
